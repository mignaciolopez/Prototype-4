...
public class PlayerControllerX : MonoBehaviour
{
    ...
    public ParticleSystem particleImpulse;
    private bool impulse = false;
    public float impulseCooldown = 2.0f;
    ...
    void Update()
    {
        ...
        particleImpulse.transform.position = transform.position + new Vector3(0, -1, 0);
